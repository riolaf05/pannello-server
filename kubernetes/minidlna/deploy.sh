...
sed 's|{{ .EXT_HD_PATH }}|/media/pi/extHD|g' resources/persistentVolume.yaml.tpl > persistentVolume.yaml
sed 's|{{ .NODE }}|$NODE_HOSTNAME|g' resources/persistentVolume.yaml.tpl > persistentVolume.yaml
