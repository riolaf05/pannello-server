...
#sed 's|\<'$NODE_TEMP'\>|'$TEMPERATURA'|g' /home/pi/volume/nodes_param.xml 
#sed -i 's|\<'$NODE_MEM_ACT'\>|'$MEMORIA_USATA'|g' /home/pi/volume/nodes_param.xml 
#sed -i 's|\<'$NODE_MEM_TOT'\>|'$MEMORIA_TOTALE'|g' /home/pi/volume/nodes_param.xml 
