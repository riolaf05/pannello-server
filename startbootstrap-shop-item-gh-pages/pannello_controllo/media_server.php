    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-md-offset-1">
				...
				<div style="height:20px";"></div> <!-- div usato per distanziare verticalmente!! -->
				<form method="POST" action='avvia_arresta_mediatomb.php'>
				<input type="submit" name="avvia" value="Avvia Mediatomb" class="btn btn-success btn-large btn-block">
				</form>
