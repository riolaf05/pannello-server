...
docker build -t "rio05docker/web_server_panel:rpi3_test_latest" startbootstrap-shop-item-gh-pages/
...
docker push rio05docker/web_server_panel:rpi3_test_latest
